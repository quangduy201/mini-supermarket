...
public class DiscountGUI extends ControlLayout {
    ...
    public DiscountGUI(List<Function> functions) {
        ...
        layoutForm.addTextLeft("Con meo:", jTextField5);
        layoutForm.addTextLeft("Con meo:", jTextField6);
        layoutForm.add("Combox:", jComboBox,20,0);
        layoutForm.addTextLeft("Con meo:", jTextField7);
        layoutForm.addTextLeft("Con meo:", jTextField8);
        layoutForm.addTextLeft("Con meo:", jTextField9);
